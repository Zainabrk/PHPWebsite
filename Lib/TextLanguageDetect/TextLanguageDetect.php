...
#use TextLanguageDetect\LanguageDetect\TextLanguageDetect_LanguageDetect_TextLanguageDetectException;
 ...
 * } catch (TextLanguageDetect_LanguageDetect_TextLanguageDetectException $e) {
 *     die($e->getMessage());
 * }
 *
 * sort($langs);
 ...
 */
class TextLanguageDetect_TextLanguageDetect
{
    /**
     ...
     * @throws TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException
     * @access private
     */
    private function _readdb($fname)
    {
        ...
        if (!file_exists($fname)) {
            throw new TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException(
                'Language database does not exist: ' . $fname,
                TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException::DB_NOT_FOUND
            );
        } elseif (!is_readable($fname)) {
            throw new TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException(
                'Language database is not readable: ' . $fname,
                TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException::DB_NOT_READABLE
            );
        }
        ...
        if (!is_array($trigram)) {
            if (ini_get('magic_quotes_runtime')) {
                throw new TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException(
                    ...
                    TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException::MAGIC_QUOTES
                );
            }
            throw new TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException(
                'Language database is not an array.',
                TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException::DB_NOT_ARRAY
            );
        } elseif (empty($trigram)) {
            throw new TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException(
                'Language database has no elements.',
                TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException::DB_EMPTY
            );
        }
    }
     ...
     * @throws TextLanguageDetect_LanguageDetect_TextLanguageDetectException
     */
    ...
    public function languageExists($lang)
    {
        ...
        if (is_string($lang)) {
            ...
            throw new TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException(
                ...
                TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException::PARAM_TYPE
            );
        }
    }
    ...
    {
        $s = new TextLanguageDetect_LanguageDetect_TextLanguageDetectParser($text);
        $s->prepareTrigram();
    ...
    {
        // input check
        if (!TextLanguageDetect_LanguageDetect_TextLanguageDetectParser::validateString($sample)) {
            return array();
        }
        ...
        $sample_obj = new TextLanguageDetect_LanguageDetect_TextLanguageDetectParser($sample);
        ...
        if ($this->_use_unicode_narrowing) {
            ...
            if (is_array($blocks)) {
                ...
                throw new TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException(
                    ...
                    TextLanguageDetect_LanguageDetect_TextLanguageDetect_LanguageDetect_TextLanguageDetectException::BLOCK_DETECTION
                );
            }
    ...
    public function detectUnicodeBlocks($str, $skip_symbols)
    {
        ...
        $sample_obj = new TextLanguageDetect_LanguageDetect_TextLanguageDetectParser($str);
        $sample_obj->prepareUnicode();
    ...
    public function clusterLanguages()
    {
        ...
        foreach ($langs as $lang) {
            if (!isset($this->_lang_db[$lang])) {
                throw new TextLanguageDetect_LanguageDetect_TextLanguageDetectException(
                    "missing $lang!",
                    TextLanguageDetect_LanguageDetect_TextLanguageDetectException::UNKNOWN_LANGUAGE
                );
            }
        }
        ...
        while (count($langs) > 2 && $i++ < 200) {
            ...
            if (!$highest_key1) {
                ...
                throw new TextLanguageDetect_LanguageDetect_TextLanguageDetectException(
                    ...
                    TextLanguageDetect_LanguageDetect_TextLanguageDetectException::NO_HIGHEST_KEY
                );
            }
    ...
    {
        // input check
        if (!TextLanguageDetect_LanguageDetect_TextLanguageDetectParser::validateString($str)) {
            return array();
        }
    ...
    private function _convertFromNameMode($lang, $convertKey = false)
    {
        ...
        if (is_string($lang)) {
            return (string)TextLanguageDetect_LanguageDetect_TextLanguageDetectISO639::$method($lang);
        }

        $newlang = array();
        foreach ($lang as $key => $val) {
            if ($convertKey) {
                $newkey = (string)TextLanguageDetect_LanguageDetect_TextLanguageDetectISO639::$method($key);
                $newlang[$newkey] = $val;
            } else {
                $newlang[$key] = (string)TextLanguageDetect_LanguageDetect_TextLanguageDetectISO639::$method($val);
            }
        }
        return $newlang;
    }
    ...
    private function _convertToNameMode($lang, $convertKey = false)
    {
        ...
        if (is_string($lang)) {
            return TextLanguageDetect_LanguageDetect_TextLanguageDetectISO639::$method($lang);
        }

        $newlang = array();
        foreach ($lang as $key => $val) {
            if ($convertKey) {
                $newkey = TextLanguageDetect_LanguageDetect_TextLanguageDetectISO639::$method($key);
                $newlang[$newkey] = $val;
            } else {
                $newlang[$key] = TextLanguageDetect_LanguageDetect_TextLanguageDetectISO639::$method($val);
            }
        }
        return $newlang;
    }
